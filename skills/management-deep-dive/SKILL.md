...
description: Researches management quality, incentives, capital allocation, culture, governance, and evidence of owner-orientation.
use_when: Use when the user asks to analyze executives, founders, board, incentives, culture, governance, or capital allocation.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/management-deep-dive.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/management-deep-dive.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
