...
description: Produces a full value-investing research report for a company using Buffett, Munger, Duan Yongping, and Li Lu perspectives.
use_when: Use when the user asks for a full fundamental investment research report on a stock or company.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/investment-research.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/investment-research.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
