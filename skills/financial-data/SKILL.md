---
name: financial-data
description: Collects, audits, reconciles, and structures financial data for public-company research workflows.
use_when: Use when the user asks to gather, validate, reconcile, normalize, or structure company financial metrics.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/financial-data.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/financial-data.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
