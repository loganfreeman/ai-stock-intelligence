...
description: Applies a disciplined value-investing checklist to a company, including business quality, management, risk, and valuation gates.
use_when: Use when the user asks to run a value-investing checklist, pass/fail review, or investment-quality gate on a company.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/investment-checklist.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/investment-checklist.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
