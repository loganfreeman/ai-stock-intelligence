---
name: earnings-team
description: Runs a multi-agent earnings-review team workflow that assigns specialist reviewers and synthesizes their findings.
use_when: Use when the user wants several earnings-review agents or perspectives coordinated into one earnings report.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/earnings-team.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/earnings-team.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
