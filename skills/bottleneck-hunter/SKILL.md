...
description: Finds investable public companies created by second- and third-order supply-chain bottlenecks behind major physical supertrends.
use_when: Use when the user asks for supply-chain bottleneck analysis, second-order picks behind a major trend, hidden beneficiaries, or physical capacity constraints.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/bottleneck-hunter.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/bottleneck-hunter.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
