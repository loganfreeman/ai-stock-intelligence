---
name: dyp-ask
description: Analyzes a company through Duan Yongping-style product truth, customer value, pricing restraint, and long-term compounding questions.
use_when: Use when the user asks for Duan Yongping-style questioning or product/customer-value evaluation of a business.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/dyp-ask.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/dyp-ask.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
