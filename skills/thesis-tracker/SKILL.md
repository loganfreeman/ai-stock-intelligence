---
name: thesis-tracker
description: Tracks an investment thesis over time with milestones, disconfirming evidence, kill criteria, and review cadence.
use_when: Use when the user asks to create, update, monitor, or audit an investment thesis over time.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/thesis-tracker.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/thesis-tracker.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
