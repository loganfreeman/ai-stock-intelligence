...
description: Funnels an industry from broad universe to high-quality investable candidates using moat, economics, and valuation filters.
use_when: Use when the user asks to narrow an industry to investable candidates or rank companies within a sector.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/industry-funnel.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/industry-funnel.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
