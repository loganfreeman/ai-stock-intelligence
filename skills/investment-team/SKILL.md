...
description: Runs the multi-agent value-investing team dialectic and synthesizes specialist investor-persona conclusions.
use_when: Use when the user asks for a multi-agent Buffett/Munger/Duan Yongping/Li Lu debate or investment committee output.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/investment-team.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/investment-team.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
