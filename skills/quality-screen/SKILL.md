---
name: quality-screen
description: Screens companies for high-quality business characteristics, durability, returns on capital, and reinvestment runway.
use_when: Use when the user asks to screen for high-quality companies, compounders, moats, returns on capital, or durable growth.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/quality-screen.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/quality-screen.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
