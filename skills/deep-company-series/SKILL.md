...
description: Builds a serialized deep-company research plan and article/report sequence for a public or private company.
use_when: Use when the user wants a multi-part company research series, serialized article outline, or long-form research publishing plan.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/deep-company-series.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/deep-company-series.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
