...
description: Researches a private company using available public sources, industry context, business model analysis, and risk checks.
use_when: Use when the user asks for research on a private company, startup, or non-public business.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/private-company-research.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/private-company-research.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
