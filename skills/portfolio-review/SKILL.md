...
description: Reviews a portfolio through position sizing, thesis drift, risk concentration, valuation, and opportunity-cost lenses.
use_when: Use when the user asks to review a portfolio, watchlist, position sizing, concentration, or thesis health.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/portfolio-review.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/portfolio-review.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
