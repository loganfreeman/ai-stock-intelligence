---
name: wechat-article
description: Converts investment research into a structured long-form WeChat-style article while preserving evidence and nuance.
use_when: Use when the user asks to turn investment research into a polished Chinese WeChat article or long-form public writeup.
source_url: https://raw.githubusercontent.com/xbtlin/ai-berkshire/main/skills/wechat-article.md
...
This Agent Skill is converted from `xbtlin/ai-berkshire/skills/wechat-article.md` for cross-agent compatibility. Follow the upstream workflow below, while applying these portability rules:
